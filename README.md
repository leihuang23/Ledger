...
The short narration (2-3 min) is in [docs/demo-script-short.md](docs/demo-script-short.md). The full five-minute narration, expected evidence, and recovery steps remain in [docs/demo-script.md](docs/demo-script.md).
